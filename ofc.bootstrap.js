...
const GA_MEASUREMENT_ID = "G-K55GX37QRY";
...
function gtag_report_conversion(url) {
  ...
  gtag("event", "conversion", {
    send_to: "AW-17808393486/Z7QpCKChl9IbEI6K2qtC",
    value: 0.1,
    currency: "AED",
...
(async function initDisplayAds() {
  ...
  const adSlots = [
    { adUnit: "/23330730517/gamzaro.com_d1", divId: "myw_top_1" },
    { adUnit: "/23330730517/gamzaro.com_d2", divId: "myw_top_2" },
    { adUnit: "/23330730517/gamzaro.com_d3", divId: "myw_top_3" },
  ];
    ...
    googletag.cmd.push(function () {
      try {
        ...
        currentSlot = googletag
          .defineOutOfPageSlot(
            "/23330730517/gamzaro.com_reward",
